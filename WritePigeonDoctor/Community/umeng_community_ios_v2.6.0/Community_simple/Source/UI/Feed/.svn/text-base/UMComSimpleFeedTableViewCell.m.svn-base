...
{
    [super awakeFromNib];
    self.feedBgView.layer.borderColor = UMComColorWithColorValueString(@"#dfdfdf").CGColor;
    ...
    _topicButton.layer.borderColor = UMComColorWithColorValueString(@"#4a98f6").CGColor;
    [_topicButton setTitleColor:UMComColorWithColorValueString(@"#4a98f6") forState:UIControlStateNormal];
    ...
    UIImage *buttonHighlightImage = [UMComKit imageFromColor:UMComColorWithColorValueString(@"#EEEEEE")];
    ...
    [self.commentButton setTitleColor:UMComColorWithColorValueString(@"#999999") forState:UIControlStateNormal];
...
- (void)reloadSubViewsFeed:(UMComFeed *)feed
{
    ...
    if ([self.feed.liked boolValue]) {
        [self.likeButton setImage:UMComSimpleImageWithImageName(@"um_like_blue") forState:UIControlStateNormal];
            [self.likeButton setTitleColor:UMComColorWithColorValueString(@"#4a98f6") forState:UIControlStateNormal];
    }else{
         [self.likeButton setImage:UMComSimpleImageWithImageName(@"um_like_gray") forState:UIControlStateNormal];
            [self.likeButton setTitleColor:UMComColorWithColorValueString(@"#999999") forState:UIControlStateNormal];
    }
    self.dateLabel.font = UMComFontNotoSansLightWithSafeSize(10);
...
//
    if (self.feed.text.length > 0) {
        ...
        if (!mutiText) {
            mutiText = [UMComMutiText mutiTextWithSize:CGSizeMake(self.feedTextView.width_, MAXFLOAT) font:FeedFont string:feedContent lineSpace:UMCom_FeedContent_LineSpace checkWords:nil textColor:UMComColorWithColorValueString(@"#333333") highLightColor:UMComColorWithColorValueString(@"#4a98f6")];
