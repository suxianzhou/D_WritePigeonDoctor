...
- (void)setUser:(RWUser *)user
{
    ...
    _header.image = _user.header?[UIImage imageWithData:_user.header]:[UIImage imageNamed:@"user_image"];
    _name.text = _user.name;
    _professionalTitle.text = _user.professionTitle;
    _office.text = [RWRequsetManager officeWithGroupID:@(_user.groupID)];
    _descriptionView.text = _user.doctorDescription;
}
...
- (void)setDefaultSettings
{
    ...
    self.backgroundView = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"officeAngle"]];
    
    _name.font = [UIFont fontWithName:@"Courier-BoldOblique" size:14];
    ...
    _professionalTitle.font = __RWGET_SYSFONT(13.f);
    _professionalTitle.adjustsFontSizeToFitWidth = YES;
    _office.textAlignment = NSTextAlignmentCenter;
    _office.textColor = [UIColor grayColor];
    _office.font = __RWGET_SYSFONT(12.f);
    
    _line.backgroundColor = __WPD_MAIN_COLOR__;
