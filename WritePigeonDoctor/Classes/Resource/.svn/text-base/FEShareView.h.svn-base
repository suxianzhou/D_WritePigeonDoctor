...
@protocol FEShareViewDelegate <NSObject>

-(void)didFinishGetUMSocialDataInDelegate:(UMSocialResponseEntity *)response;

@end

@interface FEShareView : UIView

@property(nonatomic,assign)id<FEShareViewDelegate>delegate;
